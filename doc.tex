...
\begin{description}
	...
	\item[n]: Sampling factor. This parameter, in conjunction with BW
		and Nused determines the subcarrier spacing, and the
		useful symbol time. Required values of this parameter are
		specified in 8.3.2.4.
	\item[G]: This is the ratio of CP time to ``useful'' time. Required
		values of this parameter are specified in
\end{description}
