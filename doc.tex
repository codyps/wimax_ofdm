...
<<<<<<< HEAD
 All encoded data bits will be interleaved by this block interleaver. The
  ...
  which is defined by the type of modulation and the index of the coded bit 
  before permutation.

  For our implementation, as we are only using QPSK modulation, $N_{cpc} = 2$.
  
  $N_{cpc}$ : number of coded bits per subcarrier
...
=======
	...
	$j_{k}$ : index after second permutation 
>>>>>>> b3ad7139022c631423a2109476ae1d832e2ba79e
