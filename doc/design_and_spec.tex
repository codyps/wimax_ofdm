...
the internal interfaces. \autoref{fig:flow-basic} shows the basic flow of information through the internal modules of the transmitter. Issues regarding timing, data path widths, buffering, and some minor data stream modifications are omited.
...
\begin{figure}
	\begin{center}
		...
		\caption{More detailed diagram of the tranmitter}
		\label{fig:flow-2}
	\end{center}
\end{figure}
